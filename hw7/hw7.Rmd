...
bins= cut(fmri.latent.sem[,1],10, labels=colors) # divide the first PC into 10 bins and assign each bin a color
scatterplot3d(x=col2coord,pch=10,
  xlab="x", ylab="y", zlab="z", main="Voxels binned by PC1", color = bins) # create3d plot of first PC with color indicating the loadings of each voxel
```
