...
```
\begin{center}
Figure 9: Biplot of PC1 and PC2
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 10: Screeplot of the PCAs
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 11: PCA Loadings for PC1 through PC4
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 12: summary of the Final Linear Regression
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 13: Residuals for the Linear Regression
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 14: WSS for various K number of Clusters
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 16: Demographic Comparison between Click Credit Users and Click Loan Users
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 17: QQ-Plot of Credit Score
\end{center}
```{r, echo=FALSE, cache=TRUE}
...
```
\begin{center}
Figure 18: Correlation Matrix of Variables
\end{center}
